...
class Variables:
    ...
    def initialize_vars(self):
        ...
        self.var_spinbox_sweep_actuator_explore_range_negative = tk.StringVar(value=0.1)
        self.var_spinbox_sweep_actuator_explore_range_positive = tk.StringVar(value=0.1)
